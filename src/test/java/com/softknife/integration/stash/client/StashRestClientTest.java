...
public class StashRestClientTest {
    ...
    private void getCommitByHash() throws Exception {
        // Closed: an unread, unclosed response left a half-read chunked body on a pooled connection,
        // and a later request to the same WireMock server failed with "Unexpected status line: A".
        try (Response response = stashRestClient.getCommitByHash("dummyGitHash")) {
