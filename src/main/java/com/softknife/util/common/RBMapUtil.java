...
public class RBMapUtil {
    ...
    private static final org.slf4j.Logger LOGGER = org.slf4j.LoggerFactory.getLogger(RBMapUtil.class);
    ...
    public static Map<String, Object> readAsMap(String input) {
        try {
            ...
            LOGGER.warn("Input is not a JSON object, returning an empty map: {}", e.getMessage());
            return new HashMap<>();
        }
    }
}