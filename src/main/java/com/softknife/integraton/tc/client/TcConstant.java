...
public class TcConstant {
    ...
    public static final String ERROR_RUNNING_EXCEEDED_TIME = "Build did not finish within the allowed wait";
    public static final String ERROR_NO_BUILD_RESULTS = "No build produced a result";
}
