...
package com.softknife.data.templating.generation;
...
public class JsonGenerationTemplateMapper {
    ...
    /** Same parsing as {@link com.softknife.data.templating.JsonTemplateMapper#splitByKeysValues}; one implementation. */
    public static Map<String, String> splitByKeysValues(String input, String delim, String keyDelim) {
        return com.softknife.data.templating.JsonTemplateMapper.splitByKeysValues(input, delim, keyDelim);
    }
}
